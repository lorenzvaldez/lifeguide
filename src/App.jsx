...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0a1520 0%, #1a2a3a 50%, #0a1520 100%)", color: S.text, display: "flex", flexDirection: "column", alignItems: "center", paddingBottom: 80 }}>
      ...
      {screen === "paid" && activeFeature === "doctor" && <DoctorVisitPrep onBack={() => setActiveFeature(null)} user={loggedInUser} />}
      ...
      {screen === "paid" && activeFeature === "after" && <AfterGuide onBack={() => setActiveFeature(null)} user={loggedInUser} />}
