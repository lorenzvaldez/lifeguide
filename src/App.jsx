...
const firstWeekGuide = {
  parent_declining: [
    { day: "Today", title: "Take a breath. You don't have to figure it all out right now.", detail: "The most important thing you can do today is be present. You are not behind. You have not missed anything yet. Start by writing down three things: who is your loved one's primary doctor, what medications are they currently on, and who in the family needs to be informed. That's it for today.", action: "Call one family member and say: 'We need to talk about what's happening and make a plan together.'", icon: "🫁" },
    { day: "This Week", title: "Schedule a family meeting — even if it's uncomfortable.", detail: "The families who navigate this best are the ones who get on the same page early. Old conflicts will resurface under stress — that's normal. But someone needs to be the designated point of contact with doctors and someone needs to coordinate day to day care. These don't have to be the same person. A 30 minute video call this week will save months of conflict later.", action: "Text your siblings or family: 'Can we do a quick call this week about [name]? I want to make sure we're all on the same page.'", icon: "👨‍👩‍👧‍👦" },
    { day: "This Week", title: "Have an honest conversation with their doctor.", detail: "Most families avoid asking the hard question — what is the prognosis? But knowing the realistic timeline changes everything about how you plan. You don't have to ask 'how long do they have' — instead ask: 'What should we realistically expect over the next few months?' and 'At what point should we consider hospice?' Doctors are often waiting for families to open this door.", action: "Call the doctor's office and say: 'I'd like to schedule a family meeting to discuss my [parent's] prognosis and care plan.'", icon: "🏥" },
  ],
  terminal_diagnosis: [
    { day: "Today", title: "This is shocking. Give yourself permission to feel that.", detail: "A terminal diagnosis is one of the most traumatic things a family can receive. In the next 24 hours you don't need to make any major decisions. What you need to do is make sure your loved one is not alone, and that you have someone you can call. Write down the diagnosis exactly as the doctor said it — you'll need this for insurance, second opinions, and future appointments.", action: "Write down: the exact diagnosis, the doctor's name and number, and the date. Keep this somewhere safe.", icon: "💙" },
    { day: "This Week", title: "Get a second opinion — and ask about a palliative care referral.", detail: "A second opinion is not a betrayal of your doctor — it is your right and it is smart. Many hospitals have palliative care teams whose entire job is managing comfort and quality of life alongside treatment. Ask for a referral immediately. Palliative care is not hospice — it can happen alongside active treatment and it makes everything more manageable.", action: "Call the hospital or clinic and ask: 'Does your facility have a palliative care team? I'd like a referral for my [loved one].'", icon: "⚕️" },
    { day: "This Week", title: "Start the legal documents now — while there is time.", detail: "This is the most urgent practical step and the one families delay the longest. Power of attorney and a healthcare proxy must be signed while your loved one still has the legal capacity to do so. If they lose this capacity before documents are signed, the process becomes exponentially harder and more expensive. You don't need a lawyer for basic advance directives — your state likely has free forms online.", action: "Search '[your state] advance directive form free' — most states have a free PDF you can download, print, and sign with two witnesses.", icon: "📄" },
  ],
  hospice_referral: [
    { day: "Today", title: "Hospice is not giving up. It is choosing quality of life.", detail: "The biggest misconception about hospice is that it means giving up or that death is imminent. Hospice is a philosophy of care that prioritizes comfort and dignity. Patients often live longer in hospice than they would have continued aggressive treatment. Hospice also provides your family with a nurse on call 24/7, a social worker, a chaplain, and bereavement support. You are not alone in this.", action: "Ask the hospice team: 'What services are included? Who do we call after hours? What does a typical week look like?'", icon: "🕊️" },
    { day: "Today", title: "Understand what Medicare covers — it is more than you think.", detail: "If your loved one is on Medicare, hospice is fully covered under Medicare Part A with no deductibles or copays for hospice services. This includes nursing visits, medications related to the terminal diagnosis, medical equipment like a hospital bed or wheelchair, aide services, and bereavement counseling for the family after. You should not be paying out of pocket for these services.", action: "Ask the hospice coordinator: 'Can you walk me through exactly what is covered under Medicare for our situation?'", icon: "💼" },
    { day: "This Week", title: "Set up the home for comfort and safety.", detail: "Your hospice team will help with this but there are things you can do now. Clear pathways for walking and wheelchair access. Set up a comfortable area where your loved one spends most of their time. Make sure medications are organized and labeled. Keep a notebook by their bed to log symptoms, medications given, and questions for the nurse. This notebook becomes invaluable.", action: "Start a notebook. Write today's date at the top. Log your loved one's mood, pain level, appetite, and any concerns. Bring this to every nurse visit.", icon: "📓" },
  ],
  in_hospice: [
    { day: "Today", title: "You are doing the hardest, most loving thing possible.", detail: "Being present through this process is a profound act of love. Many families feel guilt — that they should be doing more, that they made the wrong choice, that they are not handling it well enough. You are handling it. The fact that you are here, looking for guidance, means you care deeply. That is enough.", action: "Today, just be present. Sit with your loved one. Hold their hand. Play music they love. You don't have to talk.", icon: "💙" },
    { day: "This Week", title: "Know the signs that things are changing.", detail: "As the body prepares for death, there are physical signs that typically appear days or weeks before. Increased sleep and difficulty waking. Reduced appetite and thirst — this is normal and not causing suffering. Changes in breathing — periods of no breathing followed by deeper breaths. Skin color changes, especially in the hands and feet. Your hospice nurse will walk you through what to watch for specifically in your loved one's case. Do not be afraid to ask.", action: "Ask your hospice nurse: 'What specific signs should we watch for that tell us things are changing? When should we call you?'", icon: "👁️" },
    { day: "This Week", title: "Take care of yourself — you cannot pour from an empty cup.", detail: "Caregiver burnout is real and it happens fast. You need sleep. You need food. You need people around you. If you are the primary caregiver, build a rotation with other family members or friends for overnight shifts. Accept help when it is offered. Your hospice social worker can also connect you with respite care — temporary relief care so you can rest. You are not abandoning your loved one by taking care of yourself.", action: "Identify one person you can call tonight just to talk — not to update them on the situation, but to be heard yourself.", icon: "🫶" },
  ],
};
    ...
    <div style={{ minHeight: "100vh", background: `linear-gradient(135deg, #0a1520 0%, #1a2a3a 50%, #0a1520 100%)`, color: "#ffffff", fontFamily: "sans-serif" }}>
      ...
      <section style={{ minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", textAlign: "center", padding: "120px 24px 80px", position: "relative", overflow: "hidden", zIndex: 1 }}>
        ...
        <div style={{ marginTop: 48, maxWidth: 480, width: "100%" }}>
          ...
          {submitted ? (
            <p style={{ fontFamily: "Cormorant Garamond, serif", fontSize: 18, color: "#c8a97e" }}>You're on the list. We'll be in touch. 🕊️</p>
          ) : (
...
function NurseScreen({ onBack }) {
  ...
  return (
    <div style={{ maxWidth: 520, width: "100%", margin: "0 auto", padding: "60px 24px 120px" }}>
      <button onClick={onBack} style={{ background: "none", border: "none", color: S.textFaint, fontSize: 13, cursor: "pointer", fontFamily: "sans-serif", marginBottom: 32, display: "flex", alignItems: "center", gap: 8 }}>← Back</button>
      <div style={{ textAlign: "center", marginBottom: 40 }}>
        ...
        <p style={{ fontSize: 14, color: S.textDim, fontFamily: "sans-serif", lineHeight: 1.7, marginBottom: 40 }}>You show up every day for families in the hardest moments of their lives. LifeGuide Pro gives you the tools to support every family you serve — from onboarding to the final days.</p>
      </div>
      <div style={{ display: "flex", flexDirection: "column", gap: 14, marginBottom: 40 }}>
        {[
...
function EmailScreen({ onContinue, situation }) {
  ...
  return (
    <div style={{ maxWidth: 480, width: "100%", textAlign: "center", margin: "0 auto", padding: "80px 24px 40px" }}>
      ...
      <h2 style={{ fontFamily: "Cormorant Garamond, serif", fontSize: 34, fontWeight: 300, color: S.goldLight, marginBottom: 12, lineHeight: 1.2, letterSpacing: -0.5 }}>Save your guide<br />before you continue</h2>
      <p style={{ fontSize: 14, color: S.textDim, fontFamily: "sans-serif", lineHeight: 1.6, marginBottom: 36 }}>Your First Week Guide is personalized to your situation. Enter your email and we'll save it for you — so you always have it when you need it, even if you close this tab.</p>
...
function FreeGuideScreen({ answers, onUnlock, onReset, userEmail }) {
  ...
  return (
    <div style={{ maxWidth: 560, width: "100%", margin: "0 auto", padding: "50px 24px 120px" }}>
      ...
      <h2 style={{ fontFamily: "Cormorant Garamond, serif", fontSize: 32, fontWeight: 300, color: S.goldLight, marginBottom: 8, letterSpacing: -0.5, marginTop: 16 }}>Your First Week Guide</h2>
      ...
      <div style={{ textAlign: "center", marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 13, color: S.textFaint, fontFamily: "sans-serif" }}>Most families walk this journey for 3 to 12 months.<br />LifeGuide walks with you every step of the way.</p>
      </div>
      ...
      <div style={{ background: "rgba(200,169,126,0.06)", border: "1px solid rgba(200,169,126,0.25)", borderRadius: 20, padding: "36px 28px", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <p style={{ fontSize: 13, color: S.textDim, fontFamily: "sans-serif", lineHeight: 1.7, marginBottom: 28 }}>Most families are in this journey for 3 to 12 months. LifeGuide is with you every step — doctor prep, documents, family coordination, and everything that comes after.</p>
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 20 }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            <button onClick={() => window.open(STRIPE_6MONTH, "_blank")} style={{ background: "linear-gradient(135deg, #c8a97e, #a8895e)", color: S.dark, border: "none", borderRadius: 12, padding: "20px 24px", fontSize: 15, fontWeight: 700, cursor: "pointer", fontFamily: "sans-serif", width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center", boxShadow: "0 8px 24px rgba(200,169,126,0.3)" }}>
              <div style={{ textAlign: "left" }}><div style={{ fontSize: 16 }}>6 Months Access</div><div style={{ fontSize: 12, fontWeight: 400, opacity: 0.8, marginTop: 2 }}>Best for most families · Save $23</div></div>
              <div style={{ textAlign: "right" }}><div style={{ fontSize: 22, fontWeight: 700 }}>$97</div><div style={{ fontSize: 11, fontWeight: 400, opacity: 0.8 }}>one time</div></div>
            </button>
          </div>
          <button onClick={() => window.open(STRIPE_ANNUAL, "_blank")} style={{ background: "rgba(200,169,126,0.1)", color: S.goldLight, border: "1px solid rgba(200,169,126,0.35)", borderRadius: 12, padding: "18px 24px", fontSize: 15, fontWeight: 600, cursor: "pointer", fontFamily: "sans-serif", width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div style={{ textAlign: "left" }}><div>Annual Access</div><div style={{ fontSize: 12, color: S.gold, marginTop: 2 }}>Best value · Save $73</div></div>
            <div style={{ textAlign: "right" }}><div style={{ fontSize: 20, fontWeight: 700 }}>$167</div><div style={{ fontSize: 11, color: S.textFaint }}>one time</div></div>
          </button>
        </div>
